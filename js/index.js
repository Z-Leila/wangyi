$(function(){
		...
		controlArrows:false,
		// scrollingSpeed:1440,
		anchors:['首页','央视报道','视觉','交互','皮肤','功能','待办邮件','联系人邮件','科技','连接易信','马上体验'],
		// loopTop:true,
		scrollBar:true,
		// paddingTop:48,
		// fixedElements:'.nav',
...
//         move('.star-2').duration('0.7s').ease('in').y(-450).set('opacity',1).end();
//         move('.star-3').y(-377).end();
//         move('.logo').y(40).end();
//         move('#SKY-slogan2').scale(1).set('opacity',1).end();
// 	}
...
// 		navigation:true,
// 		navigationTooltips:['首页', '央视报道','视觉', '交互', '皮肤', '功能', '待办邮件', '联系人邮件', '科技', '连接易信', '马上体验'],
// 		anchors:['s1','s2','s3','s4','s5','s6','s7','s8','s9','s10','s11'],
// 		lockAnchors:true,
